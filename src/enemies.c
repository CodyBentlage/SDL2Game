...
static SDL_Texture *enemyTheCubeTexture;
static SDL_Texture *enemyBossTexture;
...
{
    Entity *enemy;
    enemyTheCubeTexture = loadTexture("gfx/enemyTheCube.png");
    ...
    if (stage.currentEnemyCount < 500)
    {
        if (--enemySpawnTimer <= 0)
        {
            ...
            enemy->texture = enemyTheCubeTexture;
...
{
    if (!stage.enemyBossSpawned)
    {
        Entity *enemy;

        enemyBossTexture = loadTexture("gfx/enemyBoss.png");
        ...
        enemy->texture = enemyBossTexture;
        SDL_QueryTexture(enemy->texture, NULL, NULL, &enemy->w, &enemy->h);
